...
static std::string pkg_log_name = app_log_path;
	...
	static WCHAR str_buf[256] = { 0 };
	static DWORD dwSize = 256; 
	static BOOL a = GetUserName(str_buf, &dwSize);
	static std::string pkg_log_name = std::string("c:/Users/") + 
XStringToLocal(XString(str_buf)) + "/AppData/Local";
