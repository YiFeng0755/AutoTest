...
//    btnTabAutoTalk->setTitleText("SendLog");
//    btnTabAutoTalk->setTitleAlignment(TextHAlignment::RIGHT);
//    btnTabAutoTalk->setTitleFontSize(20.0f);
//
//    btnTabAutoTalk->setPosition(Vec2(origin.x + visibleSize.width / 2  , origin.y + visibleSize.height / 2 ));
//    btnTabAutoTalk->addClickEventListener(CC_CALLBACK_1(MainScene::sendLogCallback, this));

    //cocos2d::log("(%f, %f)", origin.x, origin.y);
