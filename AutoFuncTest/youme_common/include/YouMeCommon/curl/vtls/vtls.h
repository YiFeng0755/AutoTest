...
#include "curl/openssl.h"        /* OpenSSL versions */

#include "curl/nssg.h"           /* NSS versions */

#include "curl/polarssl.h"       /* PolarSSL versions */

#include "curl/schannel.h"       /* Schannel SSPI version */
...
namespace youmecommon
{
	...
	unsigned int Curl_rand( youmecommon::SessionHandle *);
