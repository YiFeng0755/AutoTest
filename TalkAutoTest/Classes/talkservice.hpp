...
public:
    static std::string getLogPath() {
        ...
        appLogPath = "/sdcard/Android/data/org.cocos2dx.TalkAutoTest/files";
		static std::string wav_save_path = "/sdcard/Android/data/org.cocos2dx.TalkAutoTest/files";
...
#if (CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
        pkg_log_name = "/sdcard/Android/data/org.cocos2dx.TalkAutoTest/files";
#elif (CC_TARGET_PLATFORM == CC_PLATFORM_IOS)
